		...
		<div className={classes.root}>
			...
			>
				...
				>
					...
					<Typography className={classes.secondaryHeading}>
						See what your fellow Recursers are up to
					</Typography>
				</AccordionSummary>
				<AccordionDetails>
					<Typography>More details about Feed</Typography>
				</AccordionDetails>
			</Accordion>
			<Accordion
			...
			>
				...
				>
					...
					<Typography className={classes.secondaryHeading}>
						Get to know your immediate network better
					</Typography>
				</AccordionSummary>
				<AccordionDetails>
					<Typography>More details about Network</Typography>
				</AccordionDetails>
			</Accordion>
			<Accordion
			...
			>
				...
				<AccordionDetails>
					<Typography>More details about Discover</Typography>
				</AccordionDetails>
			</Accordion>
		</div>
	);
