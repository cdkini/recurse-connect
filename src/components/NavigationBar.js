...
var NavigationBar = function () {
    ...
    return (React.createElement("div", { className: classes.root },
        ...
        React.createElement(AppBar_1["default"], { position: "fixed", className: clsx_1["default"](classes.appBar, (_a = {},
            ...
            React.createElement(Toolbar_1["default"], null,
                ...
                React.createElement(Typography_1["default"], { variant: "h6", noWrap: true }, "Persistent drawer"))),
        React.createElement(Drawer_1["default"], { className: classes.drawer, variant: "persistent", anchor: "left", open: open, classes: {
            ...
            React.createElement(Divider_1["default"], null)),
        React.createElement("main", { className: clsx_1["default"](classes.content, (_b = {},
                _b[classes.contentShift] = open,
                _b)) },
            React.createElement("div", { className: classes.drawerHeader }),
            React.createElement(Typography_1["default"], { paragraph: true }, "Paragraph 1"),
            React.createElement(Typography_1["default"], { paragraph: true }, "Paragraph 2"))));
};
